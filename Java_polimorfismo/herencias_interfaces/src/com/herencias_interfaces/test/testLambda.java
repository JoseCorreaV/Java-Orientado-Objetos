...
import com.herencias_interfaces.Modelo.Cliente;
...
public class testLambda {
	...
	public static void main(String[] args) {
		...
		lista.sort((Cuenta o1, Cuenta o2) -> {
			// sobra el return debido a que como tiene una sola linea de codigo java, interpretara cual es el retorno
		...
		// Clase anonima || Function Object + lambda
...
//		}
		...
		//Recorrer las listas por si misma
		lista.forEach(cuenta -> System.out.println(cuenta));
		
		// ordenar de forma natural "por agencia" => el metodo esta sobre escribido en
		// cuenta
